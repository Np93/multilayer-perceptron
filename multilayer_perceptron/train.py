...
def main():
    ...
    for epoch in range(epochs):
        ...
        # if np.array_equal(train_predictions[:sample_size], train_dataset.y[:sample_size]):
        #     i = "1"
        #     best_model = model
    ...
    print(f"Best model saved as {best_model_name} with validation accuracy: {best_val_accuracy}")
